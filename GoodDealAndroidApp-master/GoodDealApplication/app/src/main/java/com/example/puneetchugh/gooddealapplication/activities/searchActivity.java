package com.example.puneetchugh.gooddealapplication.activities;
...
public class searchActivity extends AppCompatActivity {
    ...
    public void makeSearch(String keyword) {
        ...
        if (enteredPrice.equals("0.0")) {
            urlstring = "https://api.bestbuy.com/v1/products(search=" + keyword + ")?format=json&show=customerReviewAverage,customerReviewCount,sku,name,salePrice&apiKey=lAauF4W0qQRX97gJ05XvPhz4";
        } else {
            ...
            urlstring = "https://api.bestbuy.com/v1/products(search=" + keyword + "&salePrice>" + String.valueOf(min) + "&salePrice<" + String.valueOf(max) + ")?format=json&show=customerReviewAverage,customerReviewCount,sku,name,salePrice&apiKey=lAauF4W0qQRX97gJ05XvPhz4";
        }
        //urlstring="https://api.bestbuy.com/v1/products(search=oven&search=stainless&search=steel&salePrice>50&salePrice<400)?format=json&show=customerReviewAverage,customerReviewCount,sku,name,salePrice,image&apiKey=lAauF4W0qQRX97gJ05XvPhz4";
        Log.e("URL_STRING", urlstring);
    ...
    private class CallAPI extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                Log.e("GoodDeal", "Before creating HTTPUrl object");
                ...
                Log.e("GoodDeal", "ResultCode : "+resCode);
                if (resCode == HttpURLConnection.HTTP_OK) {
                    Log.e("GoodDeal", "result code : "+resCode);
                    in = httpConn.getInputStream();
                }
            } catch (MalformedURLException e) {
                Log.e("GoodDeal", "Malformed exception");
                e.printStackTrace();
            } catch (IOException e) {
                Log.e("GoodDeal", "IOException");
                e.printStackTrace();
            }
            //Log.e("GoodDeal", "InputStream : "+in.toString());
