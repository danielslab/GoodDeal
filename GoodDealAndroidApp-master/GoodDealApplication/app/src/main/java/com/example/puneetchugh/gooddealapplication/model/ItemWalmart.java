...
public class ItemWalmart {
    ...
    @Expose
    private List<ImageEntityWalmart> imageEntities = null;
    ...
    @Expose
    private GiftOptionsWalmart giftOptions;
    ...
    public List<ImageEntityWalmart> getImageEntities() {
        return imageEntities;
    }

    public void setImageEntities(List<ImageEntityWalmart> imageEntities) {
    ...
    public GiftOptionsWalmart getGiftOptions() {
        return giftOptions;
    }

    public void setGiftOptions(GiftOptionsWalmart giftOptions) {
